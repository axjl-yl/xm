        ...
        <div class="main">
          ...
          <div class="middle">
            <div class="left1">
              <div class="user">
                <div class="user_pic">
                  <img src="http://res.new.taoertao.com/upload/goods/20194/upload_d68187f5710ee1f91968fc32733bc579.jpg?imageView2/1/w/500/h/500/q/100" style="border-radius: 65px" width="130px" >
                </div>
                从session获得用户名
              </div>
              <div class="mulu">
            ...
            <div class="right" >
              <ul>
                <li v-for="(item,index) in arr.list" style="list-style: none">
                  ...
                  <div class="r_middle">
                    ...
                    <div class="del"><el-button type="text" plain @click="open(uid,item.id)">删除</el-button></div>
                  </div>
...
<script>
  import axios from 'axios'
    export default {
      ...
      methods:{
          //查询我想要的
        chawant:function (uid) {
          var _this=this
          axios.get("api/want/"+1).then(function (res) {
            _this.arr = res.data;
          })
        ...
        open:function (uid,gid) {
          ...
          this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
            ...
            axios.get("http://localhost:8000/delwant/"+"1"+"/"+gid).then(function (res) {
              _this.chawant()
            })
          }).catch(() => {
            this.$message({
